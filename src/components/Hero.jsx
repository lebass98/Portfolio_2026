...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen flex items-center justify-start bg-accent pt-16 relative overflow-hidden max-w-none">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-12 mt-16 md:mt-24">
            ...
            >
              ...
              <a href="#portfolio" className="inline-flex items-center gap-4 text-sm font-bold tracking-widest uppercase border-b-2 border-black pb-2 hover:border-black/30 hover:text-black/60 transition-all">
                View Projects
      ...
      <div className="absolute bottom-12 left-12 text-[10px] font-bold tracking-widest text-black/30 uppercase hidden md:block">
